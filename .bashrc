...
PS1='\e[37;1m\u@\e[31m\W\e[0m\$ ' # this will change your prompt format

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/cptmo/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/cptmo/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/cptmo/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/cptmo/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
